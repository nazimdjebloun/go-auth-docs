...
| Param | Values | Default | Notes |
|---|---|---|---|
| `role` | `owner`, `admin`, `member` | — (no filter) | Anything else is ignored, not rejected. |
...
| Param | Values | Default | Notes |
|---|---|---|---|
| `role` | `owner`, `admin`, `member` | — (no filter) | The role the invite grants on acceptance, not the caller's own role. |
