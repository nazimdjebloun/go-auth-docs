...
func myLoginHandler(a *goauth.Auth) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		result, err := a.Services.Auth.Login(r.Context(), service.LoginInput{
...
- `ClearSessionCookies(w)` expires both cookies — pair with `a.Services.Session.Revoke` in a custom logout handler.
