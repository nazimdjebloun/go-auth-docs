...
| Code | Status | Cause |
|---|---|---|
| `weak_password` | 400 | Too short, too long (over 128 chars), or missing a required character class — the message names exactly what's missing, e.g. `Password must be at least 12 characters with an uppercase letter` |
