...
Pass option functions to `NewConfig(opts ...Option)`. The table maps each option to its responsibility; [Configuration](./configuration.mdx) documents every field and validation rule.
